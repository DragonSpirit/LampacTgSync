(function () {
  ...
  (function () {
    ...
    function initializeAccountSettings() {
      var accountInfoBlock = $("<div class=\"myBot\" style=\"line-height: 1;color: currentColor;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;box-sizing: border-box;outline: none;user-select: none;display: flex;flex-direction: column;-webkit-box-align: start;align-items: flex-start;position: relative;background-color: rgba(255, 255, 255, 0.1);border-radius: 0.3em;margin: 1.5em 2em;\"><div class=\"ad-server__text\">Для получения токена перейдите в наш телеграм бот</div><div style=\"background-color: #ffe216;padding: 0.5em;color: #000;-webkit-border-radius: 0.3em;-moz-border-radius: 0.3em;margin-left: 1em;margin-bottom: 1em;\"=>"+botLink+"</div>");
